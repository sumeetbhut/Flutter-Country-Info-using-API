                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                          image: countryResponse.name != null &&
                                                  countryResponse
                                                      .flag.isNotEmpty
                                              ? NetworkImage(
                                ...
                                Row(
                                  children: [
                                    ...
                                    Container(
                                      margin: EdgeInsets.only(
                                          left: 20.0, right: 0.0, bottom: 0.0),
                                      child: Column(
                                        crossAxisAlignment:
                                        CrossAxisAlignment.start,
                                        children: [
                                ...
                                Row(
                                  children: [
                                    Container(
                                      margin: EdgeInsets.only(
                                          left: 10.0, top: 10.0, bottom: 16.0),
                                      child: Icon(
                                        Icons.location_city,
                                        color: ColorUtils.appColor,
                                        size: 30.0,
                                ...
                                Container(
                                  ...
                                  child: GridView.count(
                                    ...
                                    children:
                                        countryResponse.languages.map((value) {
                                      return Container(
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                          ...
                                          style: BorderStyle.solid)),
                                  child:
                                      Center(child: Text("Border Countries")),
                                ),
                                Container(
                                  margin: EdgeInsets.only(
                                      top: 20.0,
                                  ...
                                  child: ListView.builder(
                                      ...
                                      shrinkWrap: true,
                                      itemCount: countryResponse.borders.length,
                                      itemBuilder: (context, index) {
                                        return GestureDetector(
                                            behavior:
                                                HitTestBehavior.translucent,
                                            onTap: () {
                                              String textToSend = countryResponse
                                                  .borders[index]
                                                  .toLowerCase();
                                              SharedPrefUtils.setString(SharedPrefUtils.contryName, textToSend);
